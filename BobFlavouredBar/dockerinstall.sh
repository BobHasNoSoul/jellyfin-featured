#!/bin/bash
echo "========================================="
echo "THIS SCRIPT IS JUST TO INSTALL INSIDE OF DOCKER ON 10.9.11 AND HAS NOT BEEN TESTED ON OTHER VERSIONS DO NOT RUN ON ANY OTHER VERSION UNLESS YOU WANT ZERO SUPPORT FOR NOT READING THIS VERY BASIC WARNING"
echo "========================================="
echo ""
echo "THIS IS THE DOCKER VERSION"
echo ""
echo "========================================="
echo ""
