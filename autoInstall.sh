...
js='const slidesInit=()=>{const e=`${window.location.origin}/web/avatars/list.txt`,t=sessionStorage.getItem("json-credentials"),o=sessionStorage.getItem("api-key");let n=null,i=null;if(t){const e=JSON.parse(t);n=e.Servers[0].UserId,i=e.Servers[0].AccessToken}const s=e=>e.sort((()=>Math.random()-.5)),r=async(e,t)=>{const o=document.querySelector("#indexPage:not(.hide)");if(!o)return;const n=o.querySelector("#slides-container"),i=e.Id,s=`${window.location.origin}/Items/${i}/Images/Backdrop/0`,r=`${window.location.origin}/Items/${i}/Images/Logo`,[a,c]=await Promise.all([fetch(s,{method:"HEAD"}).then((e=>e.ok)),fetch(r,{method:"HEAD"}).then((e=>e.ok))]);if(a&&c){const o=((e,t)=>{const o=e.Id,n=e.Overview||"No overview available",i=document.createElement("a");i.className="slide",i.href=`${window.location.origin}/web/#/details?id=${o}`,i.target="_top",i.rel="noreferrer",i.tabIndex=0;const s=document.createElement("img");s.className="backdrop",s.src=`${window.location.origin}/Items/${o}/Images/Backdrop/0`,s.alt="Backdrop",s.loading="lazy";const r=document.createElement("img");r.className="logo",r.src=`${window.location.origin}/Items/${o}/Images/Logo`,r.alt="Logo",r.loading="lazy";const a=document.createElement("div");a.className="logo-container",a.appendChild(r);const l=document.createElement("div");l.className="featured-content",l.textContent=t;const c=document.createElement("span");c.className="plot",c.textContent=n;const d=document.createElement("div");d.className="plot-container",d.appendChild(c);const m=document.createElement("div");return m.className="gradient-overlay",i.append(m,s,a,l,d),i})(e,t);n.appendChild(o),console.log(`Added slide for item ${i}`),1===n.children.length&&l(0)}else console.warn(`Skipping item ${i}: Missing backdrop or logo.`)},a=async e=>{const t=await fetch(`${window.location.origin}/Users/${n}/Items/${e}`,{headers:{Authorization:`MediaBrowser Client="Jellyfin Web", Device="YourDeviceName", DeviceId="YourDeviceId", Version="YourClientVersion", Token="${i}"`}}),o=await t.json();return console.log("Item Title:",o.Name),console.log("Item Overview:",o.Overview),o},l=e=>{const t=document.querySelector("#indexPage:not(.hide)");if(!t)return;t.querySelectorAll(".slide").forEach(((t,o)=>{o===e?(t.style.display="block",t.offsetHeight,t.style.opacity="1",t.classList.add("active")):(t.style.opacity="0",t.classList.remove("active"),setTimeout((()=>{t.style.display="none"}),500))}))};t&&o?(async()=>{const t=await(async()=>{try{const t=await fetch(e);if(!t.ok)throw new Error("Failed to fetch list.txt");return(await t.text()).split("\n").map((e=>e.trim())).filter((e=>e))}catch(e){return console.warn("Error fetching list.txt:",e),[]}})();let o;if(t.length>0){const e=t.map((e=>a(e)));console.groupCollapsed("Item Details"),o=await Promise.all(e),console.groupEnd()}else{const e=await(async()=>{try{const e=await fetch(`${window.location.origin}/Users/${n}/Items?IncludeItemTypes=Movie,Series&Recursive=true&hasOverview=true&imageTypes=Logo,Backdrop&isPlayed=False&Limit=1500`,{headers:{Authorization:`MediaBrowser Client="Jellyfin Web", Device="YourDeviceName", DeviceId="YourDeviceId", Version="YourClientVersion", Token="${i}"`}}),t=(await e.json()).Items,o=t.filter((e=>"Movie"===e.Type)),r=t.filter((e=>"Series"===e.Type)),a=s(o),l=s(r),c=a.slice(0,$movies_count),d=l.slice(0,$series_count),m=[],u=Math.max(c.length,d.length);for(let e=0;e<u;e++)e<c.length&&m.push(c[e]),e<d.length&&m.push(d[e]);return m}catch(e){return console.error("Error fetching items:",e),[]}})(),t=e.map((e=>a(e.Id)));console.groupCollapsed("Item Details"),o=await Promise.all(t),console.groupEnd()}await(async e=>{console.groupCollapsed("Creating slides"),await Promise.all(e.map((e=>r(e,"Movie"===e.Type?"Movie":"TV Show")))),console.groupEnd()})(o),(()=>{const e=document.querySelector("#indexPage.hide");if(e){const t=e.querySelector("#slides-container"),o=e.querySelector("link"),n=e.querySelector("script");t.remove(),o.remove(),n.remove()}const t=document.querySelector("#indexPage:not(.hide)");if(!t)return;const o=t.querySelectorAll(".slide"),n=t.querySelector("#slides-container");let i=0,s=null,r=!1;const a=e=>{i=(e+o.length)%o.length,l(i)},c=()=>{s&&(window.location.href=s.href)};o.length>0&&(l(i),n.style.display="block",setTimeout((()=>{setInterval((()=>{a(i+1)}),$slide_time)}),1e4)),o.forEach((e=>{e.addEventListener("focus",(()=>{s=e,n.classList.remove("disable-interaction")}),!0),e.addEventListener("blur",(()=>{s===e&&(s=null)}),!0)})),t.addEventListener("keydown",(e=>{if(r)switch(e.keyCode){case 37:a(i-1);break;case 39:a(i+1);break;case 13:c()}})),t.addEventListener("click",(e=>{e.target.closest(".slide")&&c()})),t.addEventListener("focusin",(e=>{e.target.closest("#slides-container")&&(r=!0,n.classList.remove("disable-interaction"))})),t.addEventListener("focusout",(e=>{e.target.closest("#slides-container")||(r=!1,n.classList.add("disable-interaction"))}))})()})():console.error("No credentials or API key found.")};'
